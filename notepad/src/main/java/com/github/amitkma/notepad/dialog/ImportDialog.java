package com.github.amitkma.notepad.dialog;
...
import com.github.amitkma.notepad.adapter.FolderAdapter;
import com.github.amitkma.notepad.model.Folder;
import com.github.amitkma.notepad.widget.FixedHeightRecyclerView;
...
public class ImportDialog extends DialogFragment {
    ...
    public static ImportDialog newInstance(@StringRes int title, @Nullable String[] extensions,
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (!Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            ...
            current_path = Notepad.last_path != null ? Notepad.last_path
                            ...
                            adapter = new FolderAdapter(items, new FolderAdapter.ClickListener() {
                                ...
                                public void onClick(Folder item) {
                                    if (item.isDirectory) {
                                        ...
                                        Notepad.last_path = current_path;
                                        Notepad.instance.putPrefs(Notepad.LAST_PATH_KEY, current_path);
