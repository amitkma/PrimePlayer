...
import com.github.amitkma.notepad.widget.MaxHeightScrollView;
...
public class ContentDialog extends DialogFragment {
    ...
    public static ContentDialog newInstance(@StringRes int title, @StringRes int positive,
            @StringRes int negative, @StringRes int neutral, @LayoutRes int layoutRes,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        content = inflater.inflate(getArguments().getInt("layoutRes"),
                (MaxHeightScrollView) view.findViewById(
