...
import com.github.amitkma.notepad.fragment.DrawingNoteFragment;
import com.github.amitkma.notepad.fragment.SimpleNoteFragment;
import com.github.amitkma.notepad.fragment.template.NoteFragment;
...
public class NoteActivity extends AppCompatActivity implements NoteFragment.Callbacks {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTheme(
                Category.getStyle(data.getIntExtra(OpenHelper.COLUMN_THEME, Category.THEME_GREEN)));
        ...
        if (savedInstanceState == null) {
            if (data.getIntExtra(OpenHelper.COLUMN_TYPE, DatabaseModel.TYPE_NOTE_SIMPLE)
