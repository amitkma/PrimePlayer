...
import com.github.amitkma.primeplayer.features.bookmarks.HighlighterViewModel
...
abstract class ViewModelModule {
    ...
    @Binds
    @IntoMap
    @ViewModelKey(HighlighterViewModel::class)
    abstract fun bindHighlighterViewModel(highlighterViewModel: HighlighterViewModel): ViewModel
